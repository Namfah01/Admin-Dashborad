        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                Innovative full-stack developer leveraging diverse background to pioneer cutting-edge solutions.
                Thrives in collaborative environments, swiftly mastering new technologies.
                Dedicated to crafting high-impact applications,committed to relentless learning and achieving
            ...
            <div className="mt-6.5">
              ...
              <div className="flex items-center justify-center gap-3.5">
                ...
                <Link
                  to="http://linkedin.com/in/kanokwan-manachamni"
                  className="hover:text-primary"
                  aria-label="social-icon"
                >
                  <svg
